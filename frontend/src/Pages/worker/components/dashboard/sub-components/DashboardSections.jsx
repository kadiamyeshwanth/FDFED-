  ...
  return (
    <section className="wkd-card-section">
      <div className="wkd-section-header">
        ...
        <Link to="/workerdashboard/join_company" className="wkd-view-all-link">
          View All
        </Link>
      </div>
          ...
          offers.map((offer) => (
            <div key={offer._id} className="wkd-card">
              ...
              <div className="wkd-card-actions">
                <Link to="/workerdashboard/join_company" className="wkd-btn wkd-btn-primary">
                  View Offer
                </Link>
              </div>
            </div>
  ...
  return (
    <section className="wkd-card-section">
      <div className="wkd-section-header">
        ...
        <Link to="/workerdashboard/jobs" className="wkd-view-all-link">
          View All
        </Link>
      </div>
      <div className="wkd-cards-container">
        {jobs && jobs.length > 0 ? (
          jobs.map((job) => (
            <div key={job._id} className="wkd-card">
              ...
              <div className="wkd-card-actions">
                <Link to="/workerdashboard/jobs" className="wkd-btn wkd-btn-primary">
                  View Details
                </Link>
              </div>
            </div>
